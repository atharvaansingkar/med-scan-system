      ...
      <div className="auth-card">
        ...
        <div className="auth-content">
          ...
          <div className="oauth-buttons">
            <button type="button" className="auth-button oauth google" onClick={() => signInWithOAuth("google")}>
            ...
            <button type="button" className="auth-button oauth github" onClick={() => signInWithOAuth("github")}>
              <svg className="oauth-icon" viewBox="0 0 24 24">
